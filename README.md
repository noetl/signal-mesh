...
| [`docs/worked-example-cyber.md`](docs/worked-example-cyber.md) | **The security worked example** — a C2 beacon + token anomaly + lateral movement as one detection. Shows what event-driven escalation and the correlation tier are *for*, and marks what does not exist yet. |
